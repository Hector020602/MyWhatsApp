...
import com.example.mywhatsapp.ui.theme.Primary
...
fun MyTopBar(scrollBehavior: TopAppBarScrollBehavior) {
    ...
    TopAppBar(
        ...
        colors = TopAppBarDefaults.largeTopAppBarColors(containerColor = Primary),
        actions = {
...
fun MyTabs() {
    ...
    val titles = listOf("Chats", "Novedades", "Llamadas", "Estrella")
...
@Composable
fun AnimatedVector(){
    val image = AnimatedImageVector.animatedVectorResource(R.drawable.rotacion_corazon)
